...
if(isset($_POST['submit'])){
    ...
    $result = Transfer::updateCoachTransfer($transferid, $salaire, $clause, $date_fin, $statut);
...
<head>
    ...
    <title>Modifier - Apex Management</title>
        ...
        <main class="main-content">
            ...
            <div class="content-wrapper">
                <div class="form-container">
                    <form class="entity-form" action="edit-coach-transfer.php?id=<?= $transferdata['id'] ?>" method="post">
